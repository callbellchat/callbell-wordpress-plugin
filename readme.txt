...
Not at all! Callbell is a hosted live chat service. Simply configure the plugin and you're done!

= Which web browsers work best with this plugin =

Though designed to work on most browsers, Callbell works best in the following environment: IE 6 or later (PC), Firefox 2 or later (Mac, PC, or Linux), Safari 2 or later (Mac), Google Chrome (PC, Mac).
...
* [Customize the chat widget](https://www.callbell.eu/en/install-callbell-chat-widget-website/) to your preference.
...
* Chore: Compatibility with WordPress 5.8.

= 0.1.5 =

* Chore: Compatibility with WordPress 5.6
...
* Chore: Updated Readme with further information
